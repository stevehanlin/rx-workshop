(function () {
  ...
  const speech$ = new Observable(observer => {
    ...
    recognition.onresult = e => {
      ...
      // for some reason Chrome doesn't seem to correctly
      // support recognition.continuous = true so it only listens for a single
      // phrase. The workaround is to stop() then start() it again on end.
      recognition.stop();
    };
